...
//				}
	...
	private void login(String password, String username, boolean reconnecting, Client client) {
		...
		try {
			...
			loginMessageColor = 0xFFFFFF;
			loginDescription = "You are currently attempting to login to RuneLive.";
			drawLoginScreen();
	...
	public boolean handleRejection(int loginCode, String username, boolean reconnecting, Client client, String password)
		...
		if (loginCode == 6) {
			loginMessage = "RuneLive is currently being updated.";
		...
		if (loginCode == 7) {
			loginMessage = "RuneLive is currently busy.";
			loginMessageColor = 0xFF0000;
		...
		if (loginCode == 23) {
			loginMessage = "RuneLive is currently being launched.";
			loginMessageColor = 0xFFFF00;
		...
		if (loginCode == 28) {
			...
			loginDescription = "Your username contains some sort of character that is not supported by RuneLive.";
			loginMessageColor = 0xFF9300;
			return false;
		}
		if (loginCode == 29) {
			loginMessage = "RuneLive has been updated!";
			loginMessageColor = 0xFF0000;
