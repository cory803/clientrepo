...
import org.runelive.dump.OsrsItemListDumper;
...
public final class ItemDefinition {
	...
	public static void dumpItemsList() {
		...
		switch (customId) {
			...
			case 4587:
				...
				break;
			case 13190:
				itemDef.name = "Bond of RuneLive";
				break;

			case 13204:
				itemDef.description2 = "Use this on a bank to convert 1 token to 1,000 coins. (RuneLive RSPS)";
				break;
			case 5733:
			...
			case 7629:
				...
				itemDef.actions[4] = "Drop";
				itemDef.description = "This scroll can be redeemed for a $100 RuneLive payment. [12000 points]"
						.getBytes();
			...
			case 10934:
				...
				itemDef.description = "This scroll can be redeemed for a $25 RuneLive payment. [2500 points]".getBytes();
				itemDef.actions = new String[5];
				itemDef.actions[0] = "Redeem";
				break;
			case 10935:
				...
				itemDef.description = "This scroll can be redeemed for a $50 RuneLive payment. [5500 points]".getBytes();
				itemDef.actions = new String[5];
				itemDef.actions[0] = "Redeem";
				break;
			case 10943:
				...
				itemDef.description = "This scroll can be redeemed for a $10 RuneLive payment. [1000 points]".getBytes();
				itemDef.actions = new String[5];
				itemDef.actions[0] = "Redeem";
				break;
			case 995:
	...
	public static Sprite getSprite(int i, int j, int k) {
		...
		Canvas2D.initDrawingArea(32, 32, sprite2.myPixels, new int[32*32]);
